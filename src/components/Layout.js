...
import {faHeart, faSearch, faAngleLeft, faAngleRight, faBars, faCalendarCheck, faTimes, faFilter, faAngleDoubleLeft  } from '@fortawesome/free-solid-svg-icons'
library.add(faHeart, faSearch, faAngleLeft, faAngleRight, faBars, faCalendarCheck, faTimes, faFilter, faAngleDoubleLeft )
